...
class SmsTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Surpaimb\PhpSms\Sms', self::$sms);
    }
    ...
    public function testGetAgent()
    {
        ...
        $this->assertInstanceOf('Surpaimb\PhpSms\LogAgent', $agent);
        $luosimao = Sms::getAgent('Luosimao');
        $this->assertInstanceOf('Surpaimb\PhpSms\LuosimaoAgent', $luosimao);
    }

    public function testGetTask()
    {
        $task = Sms::getTask();
        $this->assertInstanceOf('Surpaimb\TaskBalance\Task', $task);
    }
